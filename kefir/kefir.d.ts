...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/02ac8e494e73e093555cdb4ece76047a77994e3a/kefir/kefir.d.ts
...
declare module "kefir" {
  ...
  export interface Observable<T, S> {
    ...
    valuesToErrors<U>(handler?: (value: T) => {convert: boolean, error: U}): Observable<void, S | U>;
    errorsToValues<U>(handler?: (error: S) => {convert: boolean, value: U}): Observable<T | U, void>;
    ...
    ignoreValues(): Observable<void, S>;
    ignoreErrors(): Observable<T, void>;
    ...
    sampledBy<U, V, W>(otherObs: Observable<U, V>, combinator?: (a: T, b: U) => W): Observable<W, S>;
